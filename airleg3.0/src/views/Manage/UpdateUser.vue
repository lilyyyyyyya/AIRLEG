...
<script>
    export default {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        axios.put('http://localhost:8181/Manage/update',this.ruleForm).then(function (resp) {
        ...
        created() {
            ...
            const _this = this
            axios.get('http://localhost:8181/Manage/findById/?id='+this.$route.query.id).then(function(resp){
